...
/* harmony import */ var _modules_showMoreCards__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/showMoreCards */ "./src/js/modules/showMoreCards.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_5__["default"])(); // horizontal slider

  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_7__["default"])('.feedback-slider-item', 'horizontal', '.main-prev-btn', '.main-next-btn'); // vertical slider
  ...
  Object(_modules_showMoreCards__WEBPACK_IMPORTED_MODULE_6__["default"])('.button-styles', '#styles .row');
...
var forms = function forms() {
  ...
  var upload = document.querySelectorAll('[name="upload"]'); // Валидация phone
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      item.parentNode.appendChild(statusMessage); // animation fadeOut

      item.classList.add('animated', 'fadeOutUp'); //destroy form
...
var modals = function modals() {
  // Переменная показывает, кликнута хотя бы одна кнопка или нет
...
var sliders = function sliders(slides, direction, prev, next) {
  // Current slide
  var slideIndex = 1; // stop switching slides
